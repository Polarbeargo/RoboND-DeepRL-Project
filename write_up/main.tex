...
\IEEEPARstart{D}{ee}p Q-Network(DQN) introduced to training a Q value function represented by multi-layer perceptron.
The following task will be implemented:  
